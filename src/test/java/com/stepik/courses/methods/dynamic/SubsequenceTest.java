...
import com.stepik.courses.methods.divideandconquer.CountSort;
...
//        System.out.println("Input array: " + Arrays.toString(ss.getInputArray()));
//        int expected = 3;
//        assertEquals(expected, ss.getResult(),"Test good");
